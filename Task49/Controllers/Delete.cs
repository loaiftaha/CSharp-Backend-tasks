    ...
    public class Delete : Controller
    {
        ...
        public IActionResult Get([FromQuery] string? FileName, [FromQuery] string? OwnerName)
        {
            ...
            try
            {
                ...
                if (!string.Equals(metaData.Owner, OwnerName, StringComparison.OrdinalIgnoreCase)) // I replaced to this way since i noticed that the named COULD BE CASE INSENSITIVE
